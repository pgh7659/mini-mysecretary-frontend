...
export default function Login() {
  ...
  const login = (e) => {
    ...
    window.location = `http://ec2-13-58-15-226.us-east-2.compute.amazonaws.com:8080/oauth2/authorize/${provider}?redirect_uri=http://ec2-13-58-15-226.us-east-2.compute.amazonaws.com/login/callback`;
  };
